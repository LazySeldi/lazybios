...
typedef enum { // I'm looking to implement more OSes but right now and for a long time I'm mostly going to focus on Linux.
    ...
    LAZYBIOS_BACKEND_WINDOWS, // Using Windows API Currently
...
// int lazybiosSysfs(lazybiosCTX_t* ctx); - Deprecated since we can use lazybiosFile directly instead
